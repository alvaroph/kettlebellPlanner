 ...
 * Selects 3 options deterministically.
 */
export function recommendWorkouts(availableWorkouts, history, type) {
  ...
  for (var i = 0; i < availableWorkouts.length; i++) {
    ...
    // If searchType is "strength", match "strength" tags
    // If no match, we still want to provide options, but let's be strict first
